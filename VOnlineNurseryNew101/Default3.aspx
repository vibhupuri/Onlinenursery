...
<h1>Welcome</h1>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style16"><a href ="Default2.aspx">Change Password?</a></td>
        </tr>
        <tr>
    ...
    <table class="auto-style31">
        ...
        <tr>
            ...
            <td class="auto-style35">
                ...
                <asp:CheckBox ID="CheckBox1" runat="server" Text="I have read and agreed to the" AutoPostBack="True" CausesValidation="True" OnCheckedChanged="CheckBox1_CheckedChanged" />&nbsp;<a href="Customers.html">Terms and Conditions and Privacy Policy</a> 
            </td>
        </tr>
        </table>
   <h1>Our Services</h1>
