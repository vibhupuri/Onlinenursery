...
.s11autoplay {transition: opacity 0.5s ease 0s;  opacity:0;position:absolute;right:27px;bottom:27px;width:10px;height:10px;padding:5px;cursor:pointer;}
   ...
   </head><body style="background-color: rgb(17, 116, 121);"><div id="my_container" style="left: 183px; top: 49.5px;"><canvas id="my_canvas" width="1000" height="500"></canvas><div id="control"><div></div><div>&nbsp;</div><div></div><div class="left"></div></div></div><div id="about" style="left: 489px; top: 160.5px; display: none;"><div class="badge"></div><h1></h1> <ul><li><span class="key">About us</li> <li>We provide services related to buying and selling of plants</li>,and in addition we provide information about how to take care of your garden, <li>and we conduct events,surveys and articles about plants and Gardening.</li><li>Sign up Free and Get Started!</li></ul><p></p></div><script type="text/javascript">var gaJsHost = (("https:" == document.location.protocol) ? "https://ssl." : "http://www.");
...
<div id="main">
<h1>About</h1>
    <h3>What is Online Nursery?How is it useful?</h3>
     <p>Online Nursery is developed to facilitate the ordinary individuals to search various information about the gardening that is required to maintain garden. Search for Vendor and volunteer in their city & from other city. if they want to help as a volunteer they can take part in events as volunteers and facilitates general people in knowing gardening better. This website helps individual in saving money and having improved knowledge in gardening.  This website helps user to buy plants and seed not easily available in the area surrounding them.</p>
     <h3>Objective of Online nursery</h3>
    <p>Online Nursery is developed to help ordinary individuals to search various details pertaining to information they need to create and maintain garden in their home. This website will provide information about various plants in categorized manner. User can search about the plant and seed or fertilizers they need and get complete information about them. </p> 
