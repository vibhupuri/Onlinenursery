...
.s11autoplay {transition: opacity 0.5s ease 0s;  opacity:0;position:absolute;right:27px;bottom:27px;width:10px;height:10px;padding:5px;cursor:pointer;}
       ...
       <form id="form1" runat="server">
           <div id="my_container" style="left: 183px; top: 49.5px;"><canvas id="my_canvas" width="1000" height="500"></canvas><div id="control"><div></div><div>&nbsp;</div><div></div><div class="left"></div></div></div><div id="about" style="left: 489px; top: 160.5px; display: none;"><div class="badge"></div><h1></h1> <ul><li><span class="key">Did you forget your password?</li> <li>Just enter your e-mail in the text box given below</li>  and we wil e-mail you a link to reset your password .</ul><p></p></div><script type="text/javascript">var gaJsHost = (("https:" == document.location.protocol) ? "https://ssl." : "http://www.");
...
<h1>Password Recovery</h1>
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="Send Email" OnClick="Button1_Click" style="height: 26px" />
